...
import { ArrowDownward, Download as DownloadIcon, PlayCircle, YouTube } from "@mui/icons-material";
import { useAsync } from "react-use";
import { humanFileSize } from "../../libs/filesize";
import * as classes from "../../components/movie.style";
...
function Downloader({ item }: IDownloaderProps) {
  return (
    <TableRow sx={{ "&:last-child td": { border: 0 } }}>
      ...
      <TableCell>
        <A legacyBehavior passHref href={`/play/?${new URLSearchParams({ u: item.torrent_magnet })}`}>
          <IconButton>
            <PlayCircle />
          </IconButton>
        </A>
